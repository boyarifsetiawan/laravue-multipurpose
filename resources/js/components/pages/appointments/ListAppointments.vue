                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="btn-group">
                            ...
                            <button v-for="status in appointmentStatus" :key="status.index" @click="getAppointments(status.value)" type="button" class="btn" :class="[selectedStatus === status.value ? 'btn-secondary' : 'btn-default']">
